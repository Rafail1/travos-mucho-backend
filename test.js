...
for (const item of symbols) {
    const { symbol, contractType, quoteAsset, status } = item;
    if (
        contractType !== 'PERPETUAL' ||
        quoteAsset !== 'USDT' ||
        status !== 'TRADING'
...
writeFileSync("s", JSON.stringify(res));